...
* On-click of the "Generate Password" button, the user will be greeted and asked a series of questions through alert, prompts, and confirm pop-ups.
* The application will use JavaScript to verify and store the user's responses.
* The application will use JavaScript to combine variables and return a random list of characters within parameters. 
* The final password will be displayed in the text-box within the HTML document.
* Lite styling has been applied, written in JavaScript.
